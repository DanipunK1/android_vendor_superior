...
SUPERIOR_VERSION := SuperiorOS-$(SUPERIOR_BUILD_TYPE)-$(CURRENT_DEVICE)-$(SUPERIOR_EDITION)-$(SUPERIOR_BUILD_DATE_UTC)
...
SUPERIOR_VERSION := SuperiorOS-$(SUPERIOR_BUILD_TYPE)-$(CURRENT_DEVICE)-$(SUPERIOR_EDITION)-$(SUPERIOR_BUILD_DATE_UTC)
SUPERIOR_FINGERPRINT := SuperiorOS/$(SUPERIOR_MOD_VERSION)/$(PLATFORM_VERSION)/$(SUPERIOR_BUILD_DATE_UTC)
SUPERIOR_DISPLAY_VERSION := SuperiorOS-$(SUPERIOR_MOD_VERSION)-$(SUPERIOR_EDITION)
endif
